export default (task) => {
  const title = `<article class="card card--yellow card--deadline">
  ...
  const date = `<div class="card__settings">
  ...
  const hashtagList = [...task.tags];
  const hashtags = `</div><div class="card__hashtag">
  <div class="card__hashtag-list">
    ${hashtagList.map((it) => `<span class="card__hashtag-inner">
    <input
      type="hidden"
      name="hashtag"
      value="repeat"
  ...
  const picture = `<label class="card__img-wrap card__img-wrap--empty">
    <input
      type="file"
  ...
  return title + date + hashtags + picture;
};
